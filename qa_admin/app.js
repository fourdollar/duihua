...
var comFunc = require('./common/commonFunctions');
//var CronJob = require('cron').CronJob;
//var learningOptimizationSettings = require('./learningOptimizationSettings.json');
//var learningOptimizationRoutes = require("./routes/watson_learningOptimizationRoute.js");


/****************************************************
FROM HERE NAKAYAMA MODIFIED
*****************************************************/
  ...
  comFunc.createIPList(function(){
    ...
    /*
     var job = new CronJob(learningOptimizationSettings.cronBatchSchedule, function() {
      ...
      learningOptimizationRoutes.initLOdata();
      }, function () {
